...
Cookery Lite local fonts feature is based on Webfonts Loader by WordPress Themes Team (WPTT). (https://github.com/WPTT/webfont-loader)
License: MIT
...
== Changelog ==
    ...
    * Fix: Issue with ajax requests has been fixed.
    ...
    * Update: Relevant tags for the theme have been added.
    ...
    1.0.9 - June 07, 2023
    * Fix: Design conflict with Delicious Recipe plugin for star rating has been fixed.
    * Fix: Issue in plugin installation through TGMPA due to PHP 8 deprecation warning has been fixed.
    * Update: Google Fonts Library has been updated.
    ...
    * Updated: Google Fonts library
    ...
    1.0.6 - April 7, 2022
    * Fixed: Two h1 tags on same page issue.
    * Fixed: Footer copyright link issue.
