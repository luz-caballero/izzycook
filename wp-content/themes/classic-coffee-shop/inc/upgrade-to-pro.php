...
function classic_coffee_shop_upgrade_pro_options( $wp_customize ) {
	...
	$wp_customize->add_section(
		'upgrade_premium',
		array(
			'title'    => esc_html__(CLASSIC_COFFEE_SHOP_PRO_NAME),
			'priority' => 1,
		)
	);
	...
	class Classic_Coffee_Shop_Pro_Button_Customize_Control extends WP_Customize_Control {
		...
		function render_content() {
			...
			<div class="pro_info">
				<ul>
			    	<li><a class="upgrade-to-pro pro-btn" href="<?php echo esc_url( CLASSIC_COFFEE_SHOP_PREMIUM_PAGE ); ?>" target="_blank"><i class="dashicons dashicons-cart"></i><?php esc_html_e( 'Upgrade Pro', 'classic-coffee-shop' ); ?> </a></li>
