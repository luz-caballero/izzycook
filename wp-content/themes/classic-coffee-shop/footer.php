...
?>       
    ...
    <div id="footer">
        ...
        <div class="copywrap text-center">
          <div class="container">
            <p><a href="<?php echo esc_html(get_theme_mod('classic_coffee_shop_copyright_link',__('https://www.theclassictemplates.com/products/free-coffee-shop-wordpress-theme','classic-coffee-shop'))); ?>" target="_blank"><?php echo esc_html(get_theme_mod('classic_coffee_shop_copyright_line',__('Coffee Shop WordPress Theme','classic-coffee-shop'))); ?></a> <?php echo esc_html('By Classic Templates','classic-coffee-shop'); ?></p>    
          </div>
        </div>
        <div class="clear"></div>
      </div>
...
<?php if(get_theme_mod('classic_coffee_shop_scroll_hide',true)){ ?>
  <a id="button"><?php echo esc_html( get_theme_mod('classic_coffee_shop_scroll_text',__('TOP', 'classic-coffee-shop' )) ); ?></a>
<?php } ?>
