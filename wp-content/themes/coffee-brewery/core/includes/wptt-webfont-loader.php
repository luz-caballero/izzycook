...
if ( ! class_exists( 'Coffee_Brewery_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Coffee_Brewery_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'coffee_brewery_enqueue_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function coffee_brewery_enqueue_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Coffee_Brewery_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'coffee_brewery_enqueue_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function coffee_brewery_enqueue_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Coffee_Brewery_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
